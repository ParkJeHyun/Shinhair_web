...
<!DOCTYPE html>
<html lang="ko-kr"<c:if test="${not empty id}"> id="${id}"</c:if>>
	<head>
		<meta charset="utf-8">
		<title> 관리자 </title>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="/assetcss/demo.min.css">
	...
	<body>
		...
		<script src="/asset/script_pre.js"></script>

		<jsp:doBody/>

		<script src="/asset/js/plugin/jquery-nestable/jquery.nestable.min.js"></script>
		<script src="/asset/mustache.js"></script>
		<script src="/asset/bootstrap3-typeahead.min.js"></script>
